...
influence on the decisions made by policy-makers. Zelizer uses 'interference' --
...
utilized the tidyverse, gt, and rstanarm packages @r-language. I retrieved his
code and data from its posting on the Harvard Dataverse @dataverse. Although I
could successfully replicate every result using his data, the models I used in
this paper fail to recreate his standard error values due to a fundamental
difference in our models (See: Replication).
