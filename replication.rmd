...
# Extension
 ...
 this solid line is what the data that i used to the model. discrete values of 0 and 1 explain the bunching. and shows that theres more 0 than ones in your dataset. in the back are the faded lines, they are the bayesian models that ran in the background, trying to fit the data that we provided to it to fit the model. errors with this fit, it goes behind 0 (extrapolation). Bayesian method might not be the best fit for approximinating 
 
the solid line is the data
the faded line is how the model passed in (the one i use) intreprets the data. 
